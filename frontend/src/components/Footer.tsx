...
const PHONE = '9625976683';
const WHATSAPP_URL = `https://wa.me/91${PHONE}`;
const FACEBOOK_URL = 'https://www.facebook.com/share/1JT3wtjLas/';
const INSTAGRAM_URL = 'https://www.instagram.com/ayurvedlife?igsh=YWU4ajQ0eTh2aDVv';
        ...
        <div className={styles.inner}>
          <div className={styles.brand}>
            <div className={styles.logo}>
              <Image src="/images/logo.png" alt="Ayurved Life" width={160} height={56} style={{ objectFit: 'contain', filter: 'brightness(0) invert(1)' }} />
            </div>
            <p>The Soul of Ayurveda. Ancient wisdom, modern wellness.</p>

            {/* Contact Info */}
            <div className={styles.contactRow}>
              <a href={`tel:+91${PHONE}`} className={styles.contactLink}>
